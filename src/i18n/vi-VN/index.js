...
export default {
  ...
  auth: {
    ...
    loginTab: 'Đăng nhập',
    registerTab: 'Đăng ký',
    forgotPasswordTab: 'Quên mật khẩu',
    email: 'Email',
    password: 'Mật khẩu',
    name: 'Tên hiển thị',
    ...
    rememberPassword: 'Nhớ mật khẩu chứ?',
    forgotPasswordDescription: 'Nhập địa chỉ email của bạn và chúng tôi sẽ gửi cho bạn một liên kết để đặt lại mật khẩu.',
    sendResetLink: 'Gửi liên kết đặt lại',
    resetLinkSent: 'Liên kết đặt lại mật khẩu đã được gửi! Vui lòng kiểm tra email của bạn.',
    // Reset password page
    ...
    passwordStrength: 'Mật khẩu phải chứa chữ hoa, chữ thường và số',
    // Notifications
  ...
  deviceManagement: {
    ...
    subtitle: 'Quản lý các thiết bị bạn đã đăng nhập',
    currentDevice: 'Thiết bị hiện tại',
    ipAddress: 'Địa chỉ IP',
    lastUsed: 'Sử dụng lần cuối',
    createdAt: 'Tạo lúc',
    revokeDevice: 'Thu hồi thiết bị này',
    revokeAllOthers: 'Đăng xuất tất cả thiết bị khác',
    noDevices: 'Không có thiết bị hoạt động',
    tokenStats: 'Thống kê Token',
    activeDevices: 'Hoạt động',
    expiredTokens: 'Hết hạn',
    revokedTokens: 'Đã thu hồi',
    confirmRevokeTitle: 'Thu hồi thiết bị',
    confirmRevokeMessage: 'Bạn có chắc muốn thu hồi quyền truy cập từ "{device}"?',
    confirmRevokeAllTitle: 'Thu hồi tất cả thiết bị khác',
    confirmRevokeAllMessage: 'Bạn có chắc muốn đăng xuất khỏi {count} thiết bị khác? Hành động này không thể hoàn tác.',
    deviceRevoked: 'Thu hồi thiết bị thành công',
    devicesRevoked: 'Đã thu hồi {count} thiết bị thành công',
  }
}
